...
<!-- <div class="mermaid"> -->
<!-- graph TB -->
<!-- id1[Traduce expresiones de texto a expresiones simbólicas o ecuaciones y las resuelve o las grafica] --- id2(Traduce historias a ecuaciones) -->
<!-- id2---id3(Ordena y agrupa operaciones y variables) -->
<!-- id2---id4(Traduce operaciones) -->
<!-- id2---id5(Identifica variables) -->
<!-- id2---id6(Convierte tablas ecuaciones) -->
<!-- id1---id7(Resuelve ecuaciones lineales) -->
